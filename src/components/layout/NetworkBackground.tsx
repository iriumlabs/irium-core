...
const PALETTES: Record<Theme, { auroras: string[]; stars: string[] }> = {
  ...
  solar: {
    auroras: ['251,146,60', '251,191,36', '180,83,9',   '251,146,60'],
    stars:   ['255,237,213', '251,191,36', '251,146,60'],
  },
  ocean: {
    auroras: ['34,211,238',  '103,232,249', '14,116,144', '34,211,238'],
    stars:   ['207,250,254', '103,232,249', '34,211,238'],
  },
  rose: {
    auroras: ['244,114,182', '192,132,252', '190,24,93',  '244,114,182'],
    stars:   ['252,231,243', '244,114,182', '192,132,252'],
  },
};
